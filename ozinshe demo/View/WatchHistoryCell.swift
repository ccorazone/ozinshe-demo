...
class WatchHistoryCell: UICollectionViewCell{
    static let reuseId = "WatchHistoryCell"
    
    //private let titleLabel = UILabel.createLabel(text: "continue_watch".localized(), font: UIFont(name: Fonts.bold.rawValue, size: 16)!, color: Colors.Text.primary)
    ...
    private lazy var movieNameLabel = UILabel.createLabel(font: UIFont(name: Fonts.semibold.rawValue, size: 12)!, color: Colors.Text.primary, numberOfLines: 1)
